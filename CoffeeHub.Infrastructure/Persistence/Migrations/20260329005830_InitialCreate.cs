    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BeanVarieties", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProducerName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Farms_Origins_OriginId",
                        column: x => x.OriginId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    RoasteryId = table.Column<Guid>(type: "uuid", nullable: false),
                    OriginId = table.Column<Guid>(type: "uuid", nullable: true),
                    FarmId = table.Column<Guid>(type: "uuid", nullable: true),
                    BeanVarietyId = table.Column<Guid>(type: "uuid", nullable: true),
                    RoastLevelId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    DeletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Coffees_BeanVarieties_BeanVarietyId",
                        column: x => x.BeanVarietyId,
                        principalTable: "BeanVarieties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Coffees_Farms_FarmId",
                        column: x => x.FarmId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Coffees_RoastLevels_RoastLevelId",
                        column: x => x.RoastLevelId,
                        principalTable: "RoastLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Coffees_Roasteries_RoasteryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrewingMethodId = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    CoffeeAmountInGrams = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    WaterAmountInMilliliters = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    BrewTimeInSeconds = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recipes_BrewingMethods_BrewingMethodId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coffees_BeanVarietyId",
                table: "Coffees",
                column: "BeanVarietyId");

            migrationBuilder.CreateIndex(
                name: "IX_Coffees_FarmId",
                table: "Coffees",
                column: "FarmId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Coffees_RoasteryId",
                table: "Coffees",
                column: "RoasteryId");

            migrationBuilder.CreateIndex(
                name: "IX_Coffees_RoastLevelId",
                table: "Coffees",
                column: "RoastLevelId");

            migrationBuilder.CreateIndex(
                name: "IX_Farms_OriginId",
                table: "Farms",
                column: "OriginId");

            migrationBuilder.CreateIndex(
                name: "IX_Recipes_BrewingMethodId",
                table: "Recipes",

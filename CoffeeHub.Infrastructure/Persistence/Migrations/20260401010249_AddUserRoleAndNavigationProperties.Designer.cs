...
namespace CoffeeHub.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260401010249_AddUserRoleAndNavigationProperties")]
    partial class AddUserRoleAndNavigationProperties
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CoffeeHub.Domain.Coffee.Coffee", b =>
                {
                    ...
                    b.Property<Guid?>("BeanVarietyId1")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("OriginId1")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RoastLevelId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RoastLevelId1")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RoasteryId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("RoasteryId1")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RoastLevelId1");

                    b.HasIndex("RoasteryId");

                    b.HasIndex("RoasteryId1");
            ...
            modelBuilder.Entity("CoffeeHub.Domain.Recipe.Recipe", b =>
                {
                    ...
                    b.Property<Guid?>("BrewingMethodId1")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("CoffeeHub.Domain.Recipe.Recipe", b =>
                {
                    ...
                    b.HasOne("CoffeeHub.Domain.BrewingMethod.BrewingMethod", "BrewingMethod")
                        .WithMany()
                        .HasForeignKey("BrewingMethodId1");
